...
public class ProfileView {
    ...
    public ListView<String> getPersonnagesListView() {
        return personnagesListView;
    }

    public void setPersonnages(java.util.List<String> noms) {
        personnagesListView.getItems().setAll(noms);
    }
